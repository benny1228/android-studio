...
/**
 * Created by surpr on 2016/11/15.
 */
public class video_view extends Activity implements IVideoPlayer {
    private static final String TAG = video_view.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLibVLC.attachSurface(mSurface, video_view.this);
